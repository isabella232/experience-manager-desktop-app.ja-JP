...
最新のデスクトップアプリケーションバージョン 2.1（2.1.3.1）のリリース情報は以下のとおりです。リリース日は 2021 年 6 月 8 日です。
