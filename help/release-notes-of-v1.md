...
Bulk Uploads：AEM Web UI で作成／アップロードフォルダーから大規模なフォルダー階層をアップロードしたり、アセットをコピーして Finder／エクスプローラーのデスクトップアプリケーションのコンテキストメニューで「Paste Assets」を選択した場合は、このダイアログが使用されます。
