---
title: ' [!DNL Experience Manager] デスクトップアプリバージョン1.10を使用します。'
description: Adobe Experience Managerデスクトップアプリバージョン1.10の使用方法と、デスクトップでのアセットの操作を最適化する方法について説明します。
...
# [!DNL Experience Manager]デスクトップアプリケーションv1.10 {#use-aem-desktop-app-v1x}を使用
...
>[!NOTE]
>
>デスクトップアプリは、[!DNL Experience Manager] 6.1リリースで導入され、[!DNL Experience Manager Assets Companion App]と呼ばれました。
