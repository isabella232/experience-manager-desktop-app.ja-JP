...
>[!CAUTION]
>
>ブラウズを速くするために、サムネールの生成をオフにすることをお勧めします。 アイコンフォルダーを有効にすると、プレビューー間を移動したときに、デジタルアセットがキャッシュされます。 また、ユーザーが気にしないアセットもダウンロードされ、サーバーに負荷がかかり、ユーザーの帯域幅を消費し、ユーザーのディスク領域を使用します。
