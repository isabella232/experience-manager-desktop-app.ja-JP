...
個々のユーザーに対して下位最適化されたパフォーマンスのトラブルシューティングを行う場合は、まず[アプリの制限](#limitations)を確認します。 以降の節では、個々のユーザーのパフォーマンスを改善するための提案を示します。
...
WindowsでExperience Managerを使用する場合、Windowsを設定してWebDAVクライアントのパフォーマンスを向上させることができます。 詳しくは、[https://support.microsoft.com/ja-jp/kb/2445570](https://support.microsoft.com/ja-jp/kb/2445570) を参照してください。
