...
---
# Adobe Experience Managerデスクトップアプリケーションドキュメントへの貢献

Adobe Experience Manager Desktop Appのドキュメントにご参加いただき、ありがとうございます。 アドビの読者コミュニティ全体およびアドビの従業員からのコンテンツ貢献を歓迎します。
...
アドビでは、貢献をできるだけ簡単におこなえるようにしたいと考えています。貢献方法は次の 2 とおりあります。
...
アドビの従業員がプル要求をおこなう場合は、`https://git.corp.adobe.com/AdobeDocs` のプライベートリポジトリを使用してください。

イシューの場合は、公開リポジトリを自由に使用してください。
